    ...
    <div className="hidden lg:flex flex-col top-[35%] left-0 fixed">
        <ul>
            ...
            <li className="flex justify-between items-center w-40 h-14 px-4 bg-gray-500 ml-[-100px] hover:ml-[-10px] hover:rounded-md duration-300 rounded-br">
                <a href="https://drive.google.com/file/d/1B6UhHQCxPvdsh35660hF4fWx9IeP63lA/view?usp=drive_link" className="flex justify-between items-center w-full text-white download: true ">
