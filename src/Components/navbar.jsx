  ...
  return (
    <div className=" flex justify-between items-center w-full h-16 px-4 text-white bg-black sticky top-0 z-10">
        ...
        <ul className=" hidden md:flex ">
            <Link to='home' smooth duration={500}><li className="px-4 cursor-pointer capitalize font-medium text-grey hover:scale-105 duration-200 hover:border-b-2 hover:border-blue-500">Home</li></Link>
            <Link to='about' smooth duration={500}><li className="px-4 cursor-pointer capitalize font-medium text-grey hover:scale-105 duration-200 hover:border-b-2 hover:border-blue-500">About</li></Link>
            <Link to='skills' smooth duration={500}><li className="px-4 cursor-pointer capitalize font-medium text-grey hover:scale-105 duration-200 hover:border-b-2 hover:border-blue-500">Skills</li></Link>
            <Link to='projects' smooth duration={500}><li className="px-4 cursor-pointer capitalize font-medium text-grey hover:scale-105 duration-100 hover:border-b-2 hover:border-blue-500">Projects</li></Link>
            <Link to='contact' smooth duration={500}><li className="px-4 cursor-pointer capitalize font-medium text-grey hover:scale-105 duration-100 hover:border-b-2 hover:border-blue-500">Contact</li></Link>
        </ul>
